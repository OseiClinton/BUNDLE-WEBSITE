          ...
          <div className="modal">
            ...
            {!wSuccess?(
              ...
              <>
                ...
                <div className="sdesc2">Thank you, <strong>{wForm.name}</strong>! We will approve your account within <strong>24 hours</strong>. SMS confirmation to <strong>{wForm.phone}</strong>.</div>
